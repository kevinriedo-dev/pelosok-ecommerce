                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   name="name" 
                                   value="{{ old('name') }}"
                                   placeholder="e.g., Kebaya Jawa Tengah"
                                   required>
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   name="material" 
                                   value="{{ old('material') }}"
                                   placeholder="e.g., Katun, Sutra, Kayu Jati">
                            @error('material')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('size_info') is-invalid @enderror" 
                                      ...
                                      name="size_info" 
                                      rows="2"
                                      placeholder="e.g., S, M, L, XL atau ukuran spesifik">{{ old('size_info') }}</textarea>
                            @error('size_info')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('care_instructions') is-invalid @enderror" 
                                      ...
                                      rows="3"
                                      placeholder="Cara perawatan produk...">{{ old('care_instructions') }}</textarea>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted">
                                Max size: 2MB per image. First image will be the primary image.
                            </small>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted">
                                Inactive products won't be displayed to customers
                            </small>
                        </div>
                    </div>
                </div>
            ...
            reader.onload = function(e) {
                ...
                col.innerHTML = `
                    <div class="position-relative">
                        ...
                        ${i === 0 ? '<span class="badge badge-primary position-absolute" style="top: 5px; left: 5px;">Primary</span>' : ''}
                    </div>
                `;
